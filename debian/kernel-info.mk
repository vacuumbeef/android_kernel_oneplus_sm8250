...
KERNEL_BOOTIMAGE_CMDLINE = androidboot.hardware=qcom androidboot.console=ttyMSM0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 androidboot.usbcontroller=a600000.dwc3 swiotlb=2048 loop.max_part=7 cgroup.memory=nokmem,nosocket reboot=panic_warm buildvariant=user console=tty0 droidian.lvm.prefer
...
# Defconfig to use
KERNEL_DEFCONFIG = kona-perf-halium_defconfig
...
#KERNEL_IMAGE_DTB = arch/arm64/boot/dts/qcom/sdm845-mtp.dtb
...
KERNEL_BOOTIMAGE_PATCH_LEVEL = 2020-07
